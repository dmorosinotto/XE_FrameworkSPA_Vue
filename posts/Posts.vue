...
import { postStore, postStore as store } from "./post-store";
...
onMounted(
  ...
  async () => await store.fetchPostsForUser(authStore.currUserId).catch(alert) //ALERT ERROR
);
...
onBeforeRouteLeave((to, from, next) => {
  ...
  postStore.saveLikesForUser(authStore.currUserId); //SALVO I LIKES DELL'UTENTE SU localStorage
